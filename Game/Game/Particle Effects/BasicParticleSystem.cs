...
namespace Game
{
    ...
    [Serializable]
#endif
    public class BasicParticleSystem : DefaultSpriteParticleSystem
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        //-----------------------------------------------------------
        protected float mfSizeMin = 20;
        protected float mfSizeMax = 20;
        protected Vector3 position;
        protected Vector2 collisionArea = new Vector2(75, 75);

        public Rectangle collisionRectangle
        {
            get
            {
                return new Rectangle((int)position.X - (int)(collisionArea.X / 2),
                                (int)position.Y - (int)(collisionArea.Y / 2),
                                (int)collisionArea.X,
                                (int)collisionArea.Y);
            }
        }
        ...
        /// </summary>
        public virtual void LoadParticleSystem()
        {
            //-----------------------------------------------------------
            ...
            InitialProperties.LifetimeMax = .2f;
        ...
        public virtual void InitializeParticleProperties(DefaultSpriteParticle cParticle)
        {
            //-----------------------------------------------------------
        ...
        public virtual void ParticleUpdate(GameTime time)
        {
            Emitter.PositionData.Position = position;
        }
        ...
        public virtual void changeEmitterPosition(Vector2 newPosition)
        {
            position = new Vector3(newPosition.X, newPosition.Y, 0);
        }

        protected bool blastCollision(Rectangle target)
        {
            bool collided = false;

            if (collisionRectangle.Intersects(target))
                collided = true;
